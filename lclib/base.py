...
from . import proxycall, this_lab
...
class DriverBase:
    ...
    def __init__(self):
        ...
        self.config_filename = os.path.join(this_lab['conf_path'], 'drivers', self.name + '.json')
...
class MotorBase:
    ...
    def __init__(self, name, driver):
        ...
        self.config_file = os.path.join(this_lab['conf_path'], 'motors', name + '.json')
