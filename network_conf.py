...
NETWORK_CONF = {
    ...
    'mecademic': {'control': (HOST_IPS['control'], 5010), 'device': ('10.19.48.?', 10000), 'logging': (HOST_IPS['control'], 7010)},
    'mecademic_monitor': {'control': (HOST_IPS['control'], 5015), 'device': ('10.19.48.?', 10001), 'logging': (HOST_IPS['control'], 7015)},
